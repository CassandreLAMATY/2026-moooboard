    ...
    >
        ...
        >
            ...
            <div class="body">
                <form>
                    ...
                    <div class="advanced">
                        <button
                            class="btn"
                            type="button"
                            @click="isAdvancedActive = !isAdvancedActive"
                        >
                            <div class="btn-content">
                                <img
                                    src="/images/gear-for-label.svg"
                                    alt="Gear icon"
                                />
                ...
                >
                    <img
                        src="/images/plus-small-green.svg"
                        alt="Plus icon"
                    />

            ...
            <form>
                <div class="content">
                    <div class="top">
                        <div class="container">
                            <div class="input-container">
                                <label class="font02 micro02" for="is-timetable">Pomodoro based on timetable ?</label>
                        ...
                        <div class="group">
                            <div class="input-container">
                                <label class="font06 silk02" for="focus-duration">
                                ...
                                <div class="input">
                                    <div class="btn-container">
                                        <button type="button">
                                            <img src="/images/chevron-up-small-white-07-8.svg" alt="Chevron up icon" />
                                        </button>
                                        <button type="button">
                                            <img
                            ...
                            <div class="input-container">
                                <label class="font06 silk02" for="relax-duration">
                    ...
                    <div class="buddy-container">
                        <label for="buddy" class="font06 silk02">Choose your focus session buddy</label>
                ...
                <div class="footer">
                    ...
                    <button :class="['submit', submitIsLoading ? 'loading' : '']" type="submit">
                        ...
                        <img v-else src="/images/check-light-green-24.svg" alt="Check icon" />
